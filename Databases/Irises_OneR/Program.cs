        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < table.Columns.Count - 1; i++)
            {
                ...
                for (int j = 0; j < table.Rows.Count; j++)
                {
                    ...
                    if (attributeGroup.SetosaAmount >= 3 && (j == table.Rows.Count - 1 || table.Rows[j + 1].Field<IrisClass>("IrisClass") != IrisClass.Setosa))
                    {
                    ...
                    else if (attributeGroup.VersicolorAmount >= 3 && (j == table.Rows.Count - 1 || table.Rows[j + 1].Field<IrisClass>("IrisClass") != IrisClass.Versicolor))
                    {
                        DataTable group = new DataTable();
                    ...
                    else if (attributeGroup.VirginicaAmount >= 3 && (j == table.Rows.Count - 1 || table.Rows[j + 1].Field<IrisClass>("IrisClass") != IrisClass.Virginica))
                    {
                        DataTable group = new DataTable();
